...
#ifndef DAILYMOTIONCATEGORYMODEL_H
#define DAILYMOTIONCATEGORYMODEL_H

#include "selectionmodel.h"
#include <qdailymotion/resourcesrequest.h>

class DailymotionCategoryModel : public SelectionModel
{
    Q_OBJECT
...
public:
    explicit DailymotionCategoryModel(QObject *parent = 0);
...
#endif // DAILYMOTIONCATEGORYMODEL_H
