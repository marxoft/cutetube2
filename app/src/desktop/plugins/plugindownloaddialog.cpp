    ...
    m_layout(new QFormLayout(this))
{
    ...
    connect(m_subtitleModel, SIGNAL(statusChanged(ResourcesRequest::Status)),
            this, SLOT(onSubtitleModelStatusChanged(ResourcesRequest::Status)));
...
void PluginDownloadDialog::setSubtitlesEnabled(bool enabled) {
    if (enabled) {
...
void PluginDownloadDialog::onStreamModelStatusChanged(ResourcesRequest::Status status) {
    ...
    case ResourcesRequest::Ready:
        ...
        m_buttonBox->button(QDialogButtonBox::Ok)->setEnabled(m_subtitleModel->status() != ResourcesRequest::Loading);
        break;
...
void PluginDownloadDialog::onSubtitleModelStatusChanged(ResourcesRequest::Status status) {
    ...
    m_buttonBox->button(QDialogButtonBox::Ok)->setEnabled(m_streamModel->status() == ResourcesRequest::Ready);
}
