...
#ifndef DAILYMOTIONPLAYLISTSPAGE_H
#define DAILYMOTIONPLAYLISTSPAGE_H
...
class DailymotionPlaylistsPage : public Page
{
    Q_OBJECT

public:
    explicit DailymotionPlaylistsPage(QWidget *parent = 0);
    ~DailymotionPlaylistsPage();
...
#endif // DAILYMOTIONPLAYLISTSPAGE_H
