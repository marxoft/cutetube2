...
QByteArray Settings::transfersWindowGeometry() {
    return value("UI/transfersWindowGeometry").toByteArray();
}

void Settings::setTransfersWindowGeometry(const QByteArray &geometry) {
    setValue("UI/transfersWindowGeometry", geometry);
}

QByteArray Settings::transfersWindowState() {
    return value("UI/transfersWindowState").toByteArray();
}

void Settings::setTransfersWindowState(const QByteArray &state) {
    setValue("UI/transfersWindowState", state);
}
...
QByteArray Settings::videoPlayerWindowGeometry() {
    return value("UI/videoPlayerWindowGeometry").toByteArray();
}

void Settings::setVideoPlayerWindowGeometry(const QByteArray &geometry) {
    setValue("UI/videoPlayerWindowGeometry", geometry);
}

QByteArray Settings::videoPlayerWindowState() {
    return value("UI/videoPlayerWindowState").toByteArray();
}

void Settings::setVideoPlayerWindowState(const QByteArray &state) {
    setValue("UI/videoPlayerWindowState", state);
}
