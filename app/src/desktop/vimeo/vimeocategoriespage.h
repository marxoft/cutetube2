...
#ifndef VIMEOCATEGORIESPAGE_H
#define VIMEOCATEGORIESPAGE_H
...
class VimeoCategoriesPage : public Page
{
    Q_OBJECT

public:
    explicit VimeoCategoriesPage(QWidget *parent = 0);
